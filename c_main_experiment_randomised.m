function c_main_experiment_randomised(subNo)
...
mean_thresh = 0.38; % distribution mean threshold for detecting correct answer 75% of the time.
...
input_file = strcat(p_folder_in,'trial_info.txt'); % full path of P trial direction file      
...
try        
    ...
    for block = 1:n_blocks;
        ...
        message = strcat(num2str(block), '\n\nClick to begin');  % write block message
        ...
        for trial = 1:ntrials;
            ...
            Screen('DrawTexture', w, img_tex{1}, [], img_loc{1}); % show trial image           
            Screen('Flip', w); 
