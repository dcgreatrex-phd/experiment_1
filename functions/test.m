...
for i = 1:length(DU); 
    ...
    if dir == 1 && seg == 1 && leftout == 0; % left outer
        if rightout == 0 && inner == 1
            leftout = 1;
        elseif rightout == 1 && inner == 0
            leftout = 1;
        elseif rightout == 0 && inner == 0
            leftout = 1;
        end
    elseif dir == 2 && seg == 1 && rightout == 0; % right outer
        if leftout == 0 && inner == 1
            rightout = 1;
        elseif leftout == 1 && inner == 0
            rightout = 1;
        elseif leftout == 0 && inner == 0
            rightout = 1;
        end
    elseif dir == 1 && seg == 2 && inner == 0; % inner (either left or right inner segments)
        if leftout == 0 && rightout == 1
            inner = 1;
        elseif leftout == 1 && rightout == 0
            inner = 1;
        elseif leftout == 0 && rightout == 0
            inner = 1;
        end
    elseif dir == 2 && seg == 2 && inner == 0; % inner (either left or right inner segments)
        if leftout == 0 && rightout == 1
            inner = 1;
        elseif leftout == 1 && rightout == 0
            inner = 1;
